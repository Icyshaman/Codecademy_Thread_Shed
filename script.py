...
daily_transactions_split = [daily_transaction.split(':') for daily_transaction in daily_transactions]
#print(daily_transactions_split)

transactions_clean = []
for daily_transaction in daily_transactions_split:
  temp = []
  for each in daily_transaction:
...
for i in range(len(transactions_clean)):
  customer, sale, thread = transactions_clean[i][:3]
